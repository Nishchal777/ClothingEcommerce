...
function TopNav() {
  return (
    <div className="hidden top-0 left-0 w-full z-50 h-10 lg:flex flex-col lg:flex-row  lg:justify-around  bg-gray-200 p-2 text-gray-700  md:text-xs text-xs font-semibold">
